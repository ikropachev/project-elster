...
public class OrderInfoControllerTest extends AbstractControllerTest {
    ...
    TestOrderInfo testOrderInfo1 = new TestOrderInfo(1L, "CUST-001", "SPERSON-001", YESTERDAY_STR);
    ...
    TestOrderInfo testOrderInfo6 = new TestOrderInfo(6L, "CUST-004", "SPERSON-002", TODAY_STR);
    ...
    public void getAllFromOltpTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/ordersinfo/oltp"))
